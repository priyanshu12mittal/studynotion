...
import BI1 from "../assets/Images/aboutus1.webp";
import BI2 from "../assets/Images/aboutus2.webp";
import BI3 from "../assets/Images/aboutus3.webp";
    ...
    <div className=" w-full text-white">
      ...
      <section className="flex flex-col items-center gap-8 bg-richblack-800 pt-14">
        ...
        <div className="relative flex translate-y-[60px] justify-center gap-6 ">
          <img src={BI1} className="z-10 " alt="first" />
          <img src={BI2} className="z-10" alt="second" />
          <img src={BI3} className="z-10" alt="third" />
          <div
